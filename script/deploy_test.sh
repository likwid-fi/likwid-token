...
forge script script/DeployLIKWIDTest.s.sol --broadcast --optimizer-runs 1000000 --rpc-url https://bsc-testnet.drpc.org --private-key $PRIVATE_KEY --sig "run(uint256)" 97 
