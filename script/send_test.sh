...
forge script script/SendOFTTest.s.sol --broadcast --optimizer-runs 1000000 --rpc-url https://testnet-rpc.monad.xyz  --private-key $PRIVATE_KEY --sig "run(uint256,uint256,uint256)" 10143 97 1000
...
forge script script/SendOFTTest.s.sol --broadcast --optimizer-runs 1000000 --rpc-url https://sepolia.drpc.org --private-key $PRIVATE_KEY --sig "run(uint256,uint256,uint256)" 11155111 10143 111
